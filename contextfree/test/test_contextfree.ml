...
(* #### Exercise 4 *)
let%test "zero_one_same_1" = derive same_amount [2] |> to_string = ""
let%test "zero_one_same_2" = derive same_amount [1;3;0;5;2] |> to_string = "1001"
let%test "zero_one_same_3" = derive same_amount [ 0;6;5;2;5;0;5;0;5;2 ] |> to_string = "00110101"
let%test "zero_one_same_4" = derive same_amount [1;3;0;6;5;2;5;1;3;2] |> to_string = "10001110"
